...
CREATE DATABASE IF NOT EXISTS OFICINA_RAFINHA;
...
CREATE TABLE IF NOT EXISTS PAGAMENTOS (
    ...
    VALOR_TOTAL DECIMAL(10, 2) NOT NULL DEFAULT 0000.0,
    FORMA_PAGAMENTO ENUM('DEBITO', 'CREDITO', 'PIX') NOT NULL DEFAULT 'DEBITO',
...
ALTER TABLE CLIENTES ADD IDADE_CLIENTE INT;
